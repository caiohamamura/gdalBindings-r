...
Hamamura, C. rgdalBindings: wraps around GDAL C library using Rcpp for reading and writing to Raster, version 0.1.2, accessed on December. 14 2023, available at: <https://github.com/caiohamamura/rgdalBindings>
